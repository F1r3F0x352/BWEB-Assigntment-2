styleOne.addEventListener("click",letter =>{document.getElementById("templatearea").style.backgroundImage = "url('./img/Corporate 1.png')";})
styleTwo.addEventListener("click",letter =>{document.getElementById("templatearea").style.backgroundImage = "url('./img/Corporate 2.png')";})
